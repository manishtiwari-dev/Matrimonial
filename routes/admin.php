...
Route::middleware(['admin'])->group(function () {
    ...
    Route::controller('MaritalStatusController')->prefix('marital-status')->name('marital.status.')->group(function () {
      ...
      // Mother Tongues
      Route::controller('MotherTonguesController')->prefix('mother-tongue')->name('mother.tongue.')->group(function () {
        Route::get('/', 'index')->name('all');
        Route::post('save/{id?}', 'save')->name('save');
        Route::post('delete/{id?}', 'delete')->name('delete');
    });
    ...
    // Marital Status
    Route::controller('CommunityController')->prefix('community')->name('community.')->group(function () {
        Route::get('/', 'index')->name('all');
        Route::post('save/{id?}', 'save')->name('save');
        Route::post('delete/{id?}', 'delete')->name('delete');
    });
    ...
    Route::controller('SmokingController')->prefix('smoking')->name('smoking.')->group(function () {
        Route::get('/', 'index')->name('all');
        Route::post('save/{id?}', 'save')->name('save');
        Route::post('delete/{id?}', 'delete')->name('delete');
    });
    ...
    Route::controller('DrinkingController')->prefix('drinking')->name('drinking.')->group(function () {
        Route::get('/', 'index')->name('all');
        Route::post('save/{id?}', 'save')->name('save');
        Route::post('delete/{id?}', 'delete')->name('delete');
    });
      ...
      // positionHeld Status
      Route::controller('PositionHeldController')->prefix('positionHeld')->name('positionHeld.')->group(function () {
        Route::get('/', 'index')->name('all');
        Route::post('save/{id?}', 'save')->name('save');
        Route::post('delete/{id?}', 'delete')->name('delete');
    });
