            ...
            @if ($user)
                <form action="{{ route('user.express.interest') }}" class="express-interest-form" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        @if(!empty($user->limitation))
                        @if (checkValidityPeriod(!empty($user->limitation)) && ($user->limitation->interest_express_limit == -1 || $user->limitation->interest_express_limit))
                        ...
                        @else
                            <div class="text-center">
                                @if (!checkValidityPeriod(!empty($user->limitation)))
