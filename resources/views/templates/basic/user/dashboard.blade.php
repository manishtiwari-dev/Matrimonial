    ...
    <div class="row gy-4 justify-content-center">
        <div class="dashboard-wrapper col-xxl-4 col-md-6">
            <div class="dashboard-card d-flex align-items-center flex-wrap">
                ...
                <div class="dashboard-card__content text-start">
                    <h4 class="dashboard-card__title d-block mt-0"></h5>
        ...
        <div class="dashboard-wrapper col-xxl-4 col-md-6">
            <div class="dashboard-card d-flex align-items-center flex-wrap">
                ...
                <div class="dashboard-card__content text-start">
                {{-- {{ userLimitation()['contact_view_limit'] }} --}}
                    <h4 class="dashboard-card__title d-block mt-0"></h5>
        ...
        <div class="dashboard-wrapper col-xxl-4 col-md-6">
            <div class="dashboard-card d-flex align-items-center flex-wrap">
                ...
                <div class="dashboard-card__content text-start">
                    <h4 class="dashboard-card__title d-block mt-0">{{ $user->limitation->image_upload_limit ?? 0 == -1 ? trans('Unlimited') : ($user->limitation->image_upload_limit ?? 0 - $user->total_images > 0 ? $user->limitation->image_upload_limit ?? 0 - $user->total_images : 0) }}</h5>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="package-options d-flex mt-1 flex-wrap">
                            <i class="las la-check mt-1"></i>
                            <span class="ps-2">
                                {{ $user->limitation->contact_view_limit ?? 0 == -1 ? 'Unlimited ' : $user->limitation->contact_view_limit ?? 0 }}
                                @lang('Contact View')
                            </span>
                        </div>
                        ...
                        <div class="package-options d-flex mt-1 flex-wrap">
                            <i class="las la-check mt-1"></i>
                            <span class="ps-2">
                                {{ $user->limitation->image_upload_limit ?? 0 == -1 ? 'Unlimited ' : $user->limitation->image_upload_limit ?? 0 }}
                                @lang('Image Upload')
                            </span>
                        </div>
                        <div class="mt-3">
