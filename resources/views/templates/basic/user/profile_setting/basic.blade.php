     ...
     <div class="accordion-item basic-information" id="basicInformation">
         ...
         <div class="accordion-collapse collapse show" id="panelsStayOpen-collapseBasicInfo" aria-labelledby="panelsStayOpen-basicInfo">
             <div class="accordion-body">
                 <form class="basic-info" action="" autocomplete="off" method="POST" class="needs-validation"  novalidate>
                     @csrf
                     ...
                     <div class="row">
                         ...
                         <div class="col-sm-6 mt-4">
                            <div class="input--group">
                                <select class="form-select form-control form--control" name="community" required>
                                    <option value="">@lang('Select One')</option>
                                    @if(!empty($community))
                                    @foreach ($community as $communt)
                                        <option value="{{ $communt->name }}" @selected(old('community', @$user->basicInfo->community) == $communt->name)>
                                            {{ __($communt->name) }}
                                        </option>
                                    @endforeach
                                    @endif
                        ...
                        <div class="col-sm-6 mt-4">
                            <div class="input--group">
                                <select class="form-select form-control form--control" name="mother_tongue" required>
                                    <option value="">@lang('Select One')</option>
                                    @if(!empty($motherTongue))
                                    @foreach ($motherTongue as $motherTon)
                                        <option value="{{ $motherTon->name }}" @selected(old('motherTongue', @$user->basicInfo->mother_tongue) == $motherTon->name)>
                                            {{ __($motherTon->name) }}
                                        </option>
                                    @endforeach
                                    @endif
                         ...
                         <div class="col-sm-6 mt-4">
                             <div class="input--group">
                                 <select class="form-control form--control select2-auto-tokenize" name="language[]" multiple="multiple"  placeholder="none">
