                                ...
                                <div class="col-sm-6">
                                    <div class="input--group">
                                        <select class="form-select form-control form--control" name="community">
                                            <option value="">@lang('Select One')</option>
                                            @foreach ($community as $cmnt)
                                                <option value="{{ $cmnt->name }}" @selected(old('community' == $cmnt->name))>{{ __($cmnt->name) }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-6">
                                    <div class="input--group">
                                        <select class="form-select form-control form--control" name="mother_tongue">
                                            <option value="">@lang('Select One')</option>
                                            @foreach ($motherTongue as $motherTong)
                                                <option value="{{ $motherTong->name }}" @selected(old('mother_tongue' == $motherTong->name))>{{ __($motherTong->name) }}</option>
                                            @endforeach
                                        </select>
