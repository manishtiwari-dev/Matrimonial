                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            ...
                            <h2 class="text-white">@if(!empty($user->limitation->package)){{ __($user->limitation->package->name) }}@endif</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            ...
                            <h2 class="text-white">@if(!empty($user->limitation)){{ userLimitation($user->limitation)['interest_express_limit'] }}@endif</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            ...
                            <h2 class="text-white">@if(!empty($user->limitation)){{ userLimitation($user->limitation)['contact_view_limit'] }}@endif</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            ...
                            <h2 class="text-white">@if(!empty($user->limitation)){{ $user->limitation->image_upload_limit == -1 ? trans('Unlimited') : ($user->limitation->image_upload_limit - $user->total_images > 0 ? $user->limitation->image_upload_limit - $user->total_images : 0) }}@endif</h2>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group">
                                    ...
                                    @if(!empty($religions))
                                        @foreach ($religions as $key => $relgn)
                                            <option  value="{{ $relgn->id }}"  {{ ($user->religion == $relgn->id ? "selected":"") }}   >{{ __($relgn->name) }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group ">
                                    ...
                                    @foreach ($bloodGroups as $key => $bldgrp)
                                        <option  value="{{ $bldgrp->name }}" {{ ($user->blood_group == $bldgrp->name ? "selected":"") }}>{{ __($bldgrp->name) }}</option>
                                    @endforeach
                                    @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group ">
                                    <label>@lang('Maritial Status')</label>
                                    <select class="form-control" name="title">
                                    @if(!empty($maritalStatusInfo))

                                    @foreach ($maritalStatusInfo as $key => $marital)
                                        <option  value="{{ $marital->title }}" {{ ($user->marital_status == $marital->title ? "selected":"") }}>{{ __($marital->title) }}</option>
                                    @endforeach
                                    @endif
                                </select>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group ">
                                    <label>@lang('Mother Tongue')</label>
                                    <select class="form-control" name="mother_tongue">
                                        @if(!empty($motherTongues))
                                        @foreach ($motherTongues as $key => $motherTong)
                                            <option  value="{{ $motherTong->id }}" 
                                                {{ ($user->mother_tongue == $motherTong->id ? "selected":"") }}
                                                >{{ __($motherTong->name) }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group ">
                                    <label>@lang('Community ')</label>
                                    <select class="form-control" name="community">
                                        @if(!empty($community))
                                        @foreach ($community as $key => $cmnt)
                                            <option  value="{{ $cmnt->id }}" {{($user->community == $cmnt->id ? "selected":"")}}>{{ __($cmnt->name) }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <select class="form-control" name="profession">
                                        ...
                                        @foreach ($profession as $key => $prof)
                                            <option  value="{{ $prof->id }}" {{($user->profession == $prof->id ? "selected":"")}}>{{ __($prof->name) }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="district" type="text" value="{{ @$user->address->district }}">
                                </div>
                            </div>
