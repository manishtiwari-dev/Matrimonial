...
trait SupportApiTicketManager
{
    ...
    public function storeSupportTicket(Request $request)
    {
        ...
        return  $this->sendResponse(true, $ticket, 'Ticket opened successfully!');
    ...
    public function replyTicket(Request $request)
    {
        ...
        return  $this->sendResponse(true, $ticket, 'Support ticket replied successfully!');
    ...
    public function closeTicket(Request $request)
    {
      ...
      //  return back()->withNotify($notify);
        ...
        return  $this->sendResponse(true, $ticket, 'Support ticket closed successfully!');
