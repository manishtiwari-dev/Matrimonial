    ...
    protected function basicInfo($request, $user)
    {
        if (!$request->has('button_value')) {
            ...
            $rules = [
                ...
                'mother_tongue'       => 'required|exists:mother_tongues,name',
                'community'           => 'required|exists:communities,name',
    ...
    protected function partnerExpectation($request, $user)
    {
        if (!$request->has('button_value')) {
            ...
            $rules                    = [
                ...
                'community'           => 'nullable|exists:communities,name',
                'mother_tongue'       => 'nullable|exists:mother_tongues,name',
