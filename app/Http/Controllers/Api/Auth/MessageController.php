...
class MessageController extends BaseController
{
    public function index(Request $request)
    {
        ...
        return  $this->sendResponse(true, $data, 'Message Retrieved successfully.');
    }
    ...
    public function messageStore(Request $request)
    {
        ...
        return  $this->sendResponse(true, $conversation, 'Message sent successfully.');
        ...
        return  $this->sendResponse(true, $data, 'Message sent successfully.');
    }
    ...
    {
       // return  $this->sendResponse(true, '', 'Message load successfully.');
        $user = auth()->user();
        ...
        return  $this->sendResponse(true, $data, 'Message load successfully.');
    }
